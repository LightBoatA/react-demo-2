...
export const DeviceAdd: React.FC<IProps> = props => {
    ...
    useEffect(() => {
        ...
        if (id && deviceData) {
            ...
            form.setFieldsValue({
                ...
                description,
                specificationParams: specificationParams ? specificationParams.map((item) => {
                        ...
                        <div className="page-device-add">
                            ...
                            >
                                <BasicInfoForm
                                    ...
                                    isEdit={id}
                                />
                                <Form.Item name="specificationParams">
                                    <SpecInfo />
                                </Form.Item>
                                {/* <Form.Item name="attachments mb50"> */}
                                <DeviceInfo
                                    form={form}
                                    fileList={fileList}
    ...
    }, [fileList, form, handleSubmit, handleUploadChange, history, id]);
